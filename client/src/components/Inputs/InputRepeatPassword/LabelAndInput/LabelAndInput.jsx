...
import { repeatPasswordLabel } from '../../../../constants/textConstants';

export default function LabelAndInput({ register, errors }) {
  return (
    <>
      <label htmlFor="repeatPassword" className="block text-sm max-sm:ml-1 self-start font-medium text-gray-900">
        { repeatPasswordLabel }
      </label>
      <input 
        type="password" 
        id="repeatPassword" 
        {...register("repeatPassword", passwordValidationRules)}
